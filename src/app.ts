...
//Project Type
enum ProjectStatus {Active, Fnished}
...
abstract class Component<T extends HTMLElement, U extends HTMLElement> {
    ...
    constructor(templateId: string, hostElementId: string, isertAtStart: boolean,
                newElementId?: string) {
    ...
    private attach(insertAtBegining: boolean) {
        this.hostElement.insertAdjacentElement(insertAtBegining ? "afterbegin" : "beforeend",
            this.element);
    }
}
...
class ProjectList extends Component <HTMLDivElement, HTMLElement> implements DragTarget {
    ...
    dropHandler(event: DragEvent) {
        ...
        projectState.moveProject(prjId,
            this.type === "active" ? ProjectStatus.Active : ProjectStatus.Fnished)
    }
